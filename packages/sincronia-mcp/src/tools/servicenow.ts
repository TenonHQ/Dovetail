 ...
 *
 * Imports only createClient from @tenonhq/sincronia-servicenow and uses
...
import { createClient } from "@tenonhq/sincronia-servicenow";
import type { ServiceNowClient } from "@tenonhq/sincronia-servicenow";
